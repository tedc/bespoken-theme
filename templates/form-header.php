...
$name_row = (!empty($_POST['sender'])) ? '<tr style="border-bottom: 1px solid #e1e1e1;"><td style="text-align:center;padding:20px;"><em style="color:#7d7d7d;font-size:12px;font-style:italic">Da</em><br />'.$sender.'</td></tr>' : "";
$email_row = (!empty($_POST['email'])) ? '<tr style="border-bottom: 1px solid #e1e1e1;"><td style="text-align:center;padding:20px;"><em style="color:#7d7d7d;font-size:12px;font-style:italic">Email</em><br />'.$email.'</td></tr>' : "";
