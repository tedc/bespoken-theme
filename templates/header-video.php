<?php if(get_field('cover_video')) : ?>
    ...
    <div class="video-cover video-cover-header" style="background-image:url(<?php echo $file; ?>.jpg)" ng-sm trigger-element="#header" trigger-hook="onLeave" duration="120%" to="{y : '10%'}" offset="100">
