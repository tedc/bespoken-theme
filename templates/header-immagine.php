...
<div class="cover" id="page-header-cover" ng-sm trigger-element="#header" trigger-hook="onLeave" duration="120%" from="{'background-position':'50% 50%'}" to="{'background-position':'50% 100%'}"></div>