<?php
	...
	function carousel($q, $el, $mw, $l = false) { ?>
		<?php
			if($q->have_posts()) : 
		?>
		<div<?php if($q->found_posts > 1) : ?> ng-carousel items="<?php echo $el; ?>" max="<?php echo $q->found_posts; ?>" mousewheel="<?php echo $mw; ?>"<?php endif; ?> class="carousel<?php echo ($l) ? ' closing' : (is_front_page()) ? '' : ' inline'; ?>"<?php echo ($l) ? ' id="last-related"' : ''; ?>>
