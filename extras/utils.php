<?php
	...
	function carousel($q, $el, $mw, $l = false) { ?>
		<?php
			if($q->have_posts()) : 
		?>
		<div<?php if($q->found_posts > 1) : ?> ng-carousel items="<?php echo $el; ?>" max="<?php echo $q->found_posts; ?>" mousewheel="<?php echo $mw; ?>"<?php endif; ?>  ng-mouse-wheel-down="scrollMove(true)"  ng-mouse-wheel-up="scrollMove(false)" class="carousel<?php echo ($l) ? ' closing' : ''; ?>"<?php echo ($l) ? ' id="last-related"' : ''; ?>>
