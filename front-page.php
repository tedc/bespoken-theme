<section class="home-page">
	<header class="page-header" id="header" ng-sm from="{y: 0, overflow: 'visible'}" to="{y : 60, overflow: 'visible'}" duration="100%" trigger-hook="onLeave" offset="50" trigger-element=".home-page">
		<div class="gradient" ng-sm to="{y : -60, boxShadow : 'inset 0px -35px 27px -32px rgba(0,0,0,0.52)'}" duration="100%" trigger-hook="onLeave" offset="50" trigger-element=".home-page" class-toggle="paused"></div>
