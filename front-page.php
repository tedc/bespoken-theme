<section class="home-page" ng-sm class-toggle="scrolled" trigger-element=".main" trigger-hook="0" offset="50">
	<header class="page-header" id="header" ng-sm from="{y: 0, overflow: 'visible'}" to="{y : 60, overflow: 'visible'}" duration="100%" trigger-hook="onLeave" offset="50" trigger-element=".home-page">
		<div class="gradient" ng-sm to="{y : -60}" duration="100%" trigger-hook="onLeave" offset="50" trigger-element=".home-page" class-toggle="paused"></div>
		<h2 class="home-title" ng-sm from="{opacity: 1}" to="{opacity: 0}" duration="100%" trigger-hook="onLeave" offset="50" trigger-element=".home-page">
