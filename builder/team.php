            ...
            <div class="user-details">
                ...
                <nav class="user-details-social">
                    ...
                    <?php endif ?>
                        ...
                        <a class="icon-facebook" href="<?php echo (string)$user_info['facebook']; ?>" target="_blank"></a>
                        ...
                        <a class="icon-instagram" href="<?php echo (string)$user_info['googleplus']; ?>" target="_blank"></a>
