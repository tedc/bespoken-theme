        ...
        <div class="col-<?php the_sub_field("n_cols") ?> user-col">
            ...
            <div class="user-details">
                ...
                <nav class="user-details-social">
                    ...
                    <a class="icon-twitter" href="https://twitter.com/<?php the_author_meta( 'twitter',  $user["ID"] ); ?>"></a>
                    <a class="icon-instagram" href="<?php the_author_meta( 'google_plus',  $user["ID"] ); ?>"></a>
                </nav>
            </div>
        </div>
    <?php endforeach; ?>
